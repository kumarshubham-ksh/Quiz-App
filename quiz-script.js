...
function showResultBox(){
    ...
    if(userScore < 5){
        let scoreTag = '<span>Sorry, you got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
    else if((userScore > 4) && (userScore < 8)){
        let scoreTag = '<span>You managed to get <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>Congrats, you got <p>' + userScore + '</p> out of <p>' + questions.length + '</p> marks!</span>';
        scoreText.innerHTML = scoreTag;
    }
}
